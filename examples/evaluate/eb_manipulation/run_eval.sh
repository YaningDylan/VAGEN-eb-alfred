#!/bin/bash
# Run EB-Manipulation evaluation with VAGEN.
#
# Prerequisites:
#   1. Start the EB-Manipulation env server first: ./start_server.sh
...
#   ./run_eval.sh config.yaml envs[0].n_envs=10       # override n_envs
