...
export WANDB_API_KEY=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

BASEDIR=/root/workspace/VAGEN-eb-alfred
SCRIPTDIR=${BASEDIR}/examples/eb_alfred
...
REF_MODEL_PATH=/workspace/.hf_home/hub/models--err00rr--Qwen2.5-VL-3B-Instruct-EB-ALFRED-vagen-sft/snapshots/d4cb53e42245a310db326833263051a320ace840
...
PYTHONUNBUFFERED=1 python3 -m vagen.main_ppo \
    ...
    trainer.total_training_steps=400 2>&1 | tee /tmp/ppo_run10.log
